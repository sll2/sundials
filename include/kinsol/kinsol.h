...
SUNDIALS_EXPORT int KINSetMaxIterCAA(void *kinmem, long int mxiter);
SUNDIALS_EXPORT int KINSetMCAA(void *kinmem, long int mcaa);
SUNDIALS_EXPORT int KINSetOrthCAA(void *kinmem, int orthaa);
SUNDIALS_EXPORT int KINSetDampingCAA(void *kinmem, realtype beta);
